...
def create_spark():
        ...
        #create cruise ship schema so that spark does not have to read the file twice thoguh for this file
        #it is not a big deal as it has less than 200 rows
        cruise_schema = StructType([
                                   ...
                                   StructField("RiverBoat", BooleanType(),True)
                                 ])
