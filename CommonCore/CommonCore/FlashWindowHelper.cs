...
namespace CommonCore
{
    ...
    public class FlashWindowHelper
    {
        ...
        public void FlashApplicationWindow(IntPtr handle)
        {
        ...
        {
            InitializeHandle(this.mainWindowHWnd);
        ...
        private void InitializeHandle(IntPtr handle)
        {
